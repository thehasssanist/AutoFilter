...
class AutoFilter:
    ...
    def initGui(self):
        ...
        self.action = QAction(QIcon(os.path.join(os.path.dirname(__file__), 'icon.png')), 'Add Filters', self.iface.mainWindow())
        self.action.triggered.connect(self.run)
        
        # Create action for multi-filter options
        self.multi_filter_action = QAction(QIcon(os.path.join(os.path.dirname(__file__), 'MultiFilter')), 'Multi-Filters', self.iface.mainWindow())
